...
export interface UserDetailProfile {
  ...
  membership_fee?: number | null; // 가입비
  membership_fee_success?: number | null; // 성혼비
...
export interface UserJob {
  ...
  occupation?: string | null; // 직업/업무 분야
  position?: string | null; // 직위
  employment_type?: string | null; // 고용 형태 (정규직, 계약직 등)
  ...
  years_of_service?: number | null; // 재직 연차
}
